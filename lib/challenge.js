...
function prompt8() {
  ...
  if(someNumber < 30) {
    ...
    conesole.log("The number is medium sized")
  }
...
// Got confused on what went around the Math.floor 
...
// had to use google to figure this one out got confused on the console.log part **
