 ...
 */
let prompt4Number = 10;
function prompt4() {
  while (prompt4Number >= 0) {
    console.log(prompt4Number);
    prompt4Number--;
  }
}
...
let prompt5Number = 5;
function prompt5() {
  while (prompt5Number >= -5) {
    console.log(prompt5Number);
    prompt5Number--;
  }
}
...
function prompt8() {
  if (someNumber < 30) {
    console.log(`My goodness! You landed on number ${someNumber}? That is one small number!`)
  } else if (someNumber <= 60) {
    console.log(`Not too bad! You got number ${someNumber}. That is medium sized.`)
  } else {
    console.log(`Amazing! You got ${someNumber}! Incredible, that's a big one!`)
  }
